        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {filteredEmployees.map((emp, index) => (
              <div
                key={emp._id}
                className={`bg-white rounded-3xl shadow-md p-6 flex flex-col items-center text-center border border-blue-200
                  transform transition-all duration-300 hover:scale-105 hover:shadow-2xl animate-fadeIn`}
              ...
              >
                ...
                <div className="absolute top-4 right-4">
                  ...
                  <div
                    className={`absolute right-0 mt-2 w-32 bg-white border border-gray-300 rounded-md shadow-lg z-10 overflow-hidden transition-all duration-300 ${
                      showDropdown === emp._id ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'
                    }`}
                  >
                    <button
                ...
                {/* Info */}
                <h2 className="text-2xl font-semibold text-blue-700">{emp.name || 'No Name'}</h2>
                <span
                ...
                <p className="text-gray-500 text-sm mt-2">{emp.department || 'N/A'}</p>
                ...
                <div className="flex flex-col items-center mt-3 gap-1">
                  <div
                    ...
                    data-tooltip-content={emp.email || 'N/A'}
                  >
                    <FiMail /> {emp.email?.slice(0, 15) || 'N/A'}
                  </div>
                  ...
                  <div
                    ...
                    data-tooltip-content={emp.phone || 'N/A'}
                  >
                    <FiPhone /> {emp.phone?.slice(0, 12) || 'N/A'}
                  </div>
